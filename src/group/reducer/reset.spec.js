...
describe("form group " + reset_1.resetReducer.name, function () {
    ...
    it('should reset state if all children are reset when control child is updated', function () {
        var state = state_1.cast(test_util_1.setPropertiesRecursively(test_util_1.INITIAL_STATE_FULL, [['isDirty', true], ['isPristine', false], ['isTouched', true], ['isUntouched', false], ['isSubmitted', true], ['isUnsubmitted', false]], test_util_1.FORM_CONTROL_INNER2_ID, test_util_1.FORM_CONTROL_INNER3_ID, test_util_1.FORM_CONTROL_INNER5_ID));
        var resultState = reset_1.resetReducer(state, new actions_1.ResetAction(test_util_1.FORM_CONTROL_INNER_ID));
        expect(resultState.isDirty).toEqual(false);
        expect(resultState.isPristine).toEqual(true);
        expect(resultState.isTouched).toEqual(false);
        expect(resultState.isUntouched).toEqual(true);
    ...
    it('should reset state if all children are reset when group child is updated', function () {
        var state = state_1.cast(test_util_1.setPropertiesRecursively(test_util_1.INITIAL_STATE_FULL, [['isDirty', true], ['isPristine', false], ['isTouched', true], ['isUntouched', false], ['isSubmitted', true], ['isUnsubmitted', false]], test_util_1.FORM_CONTROL_INNER_ID, test_util_1.FORM_CONTROL_INNER2_ID, test_util_1.FORM_CONTROL_INNER5_ID));
        var resultState = reset_1.resetReducer(state, new actions_1.ResetAction(test_util_1.FORM_CONTROL_INNER3_ID));
        expect(resultState.isDirty).toEqual(false);
        expect(resultState.isPristine).toEqual(true);
    });
    it('should reset state if all children are reset when array child is updated', function () {
        var state = state_1.cast(test_util_1.setPropertiesRecursively(test_util_1.INITIAL_STATE_FULL, [['isDirty', true], ['isPristine', false], ['isTouched', true], ['isUntouched', false], ['isSubmitted', true], ['isUnsubmitted', false]], test_util_1.FORM_CONTROL_INNER_ID, test_util_1.FORM_CONTROL_INNER2_ID, test_util_1.FORM_CONTROL_INNER3_ID));
        var resultState = reset_1.resetReducer(state, new actions_1.ResetAction(test_util_1.FORM_CONTROL_INNER5_ID));
        expect(resultState.isDirty).toEqual(false);
        expect(resultState.isPristine).toEqual(true);
    });
});
