...
describe("form group " + clear_async_error_1.clearAsyncErrorReducer.name, function () {
    ...
    it('should aggregate child errors', function () {
        ...
        var value = true;
        var errors = { min: 0 };
        var state = __assign({}, test_util_1.INITIAL_STATE, { pendingValidations: [name], isValidationPending: true, errors: (_a = {}, _a['$' + name] = value, _a), controls: {
                inner: __assign({}, test_util_1.INITIAL_STATE.controls.inner, { isValid: false, isInvalid: true, errors: errors }),
            } });
        var resultState = clear_async_error_1.clearAsyncErrorReducer(state, new actions_1.ClearAsyncErrorAction(test_util_1.FORM_CONTROL_ID, name));
    ...
    it('should aggregate child errors for group children', function () {
        ...
        var value = true;
        var errors = { min: 0 };
        var state = __assign({}, test_util_1.INITIAL_STATE_FULL, { pendingValidations: [name], isValidationPending: true, errors: (_a = {},
                _a['$' + name] = value,
                _a._inner3 = errors,
                _a), controls: __assign({}, test_util_1.INITIAL_STATE_FULL.controls, { inner3: __assign({}, test_util_1.INITIAL_STATE_FULL.controls.inner3, { isValid: false, isInvalid: true, errors: errors }) }) });
        var resultState = clear_async_error_1.clearAsyncErrorReducer(state, new actions_1.ClearAsyncErrorAction(test_util_1.FORM_CONTROL_ID, name));
    ...
    it('should aggregate child errors for array children', function () {
        ...
        var state = __assign({}, test_util_1.INITIAL_STATE_FULL, { pendingValidations: [name], isValidationPending: true, errors: (_a = {},
                _a['$' + name] = value,
                _a._inner5 = errors,
                _a), controls: __assign({}, test_util_1.INITIAL_STATE_FULL.controls, { inner5: __assign({}, test_util_1.INITIAL_STATE_FULL.controls.inner5, { isValid: false, isInvalid: true, errors: errors }) }) });
        var resultState = clear_async_error_1.clearAsyncErrorReducer(state, new actions_1.ClearAsyncErrorAction(test_util_1.FORM_CONTROL_ID, name));
    ...
    it('should aggregate multiple child errors', function () {
        ...
        var state = __assign({}, test_util_1.INITIAL_STATE_FULL, { pendingValidations: [name], isValidationPending: true, errors: (_a = {},
                ...
                _a._inner3 = errors2,
                _a), controls: {
                inner: __assign({}, test_util_1.INITIAL_STATE_FULL.controls.inner, { isValid: false, isInvalid: true, errors: errors1 }),
                inner3: __assign({}, test_util_1.INITIAL_STATE_FULL.controls.inner3, { isValid: false, isInvalid: true, errors: errors2 }),
            } });
        var resultState = clear_async_error_1.clearAsyncErrorReducer(state, new actions_1.ClearAsyncErrorAction(test_util_1.FORM_CONTROL_ID, name));
    ...
    it('should track child errors and own errors when own errors are changed', function () {
        ...
        var state = __assign({}, test_util_1.INITIAL_STATE, { errors: (_a = {},
                ...
                inner: __assign({}, test_util_1.INITIAL_STATE.controls.inner, { isValid: false, isInvalid: true, errors: (_c = {}, _c['$' + name2] = value2, _c) }),
            } });
        ...
        expect(resultState.errors).toEqual({ _inner: (_d = {}, _d['$' + name2] = value2, _d) });
        expect(resultState.isValidationPending).toEqual(false);
        var _a, _b, _c, _d;
    });
    it('should track own errors and child errors when child errors are changed', function () {
        ...
        var state = __assign({}, test_util_1.INITIAL_STATE, { errors: (_a = {},
                ...
                inner: __assign({}, test_util_1.INITIAL_STATE.controls.inner, { isValid: false, isInvalid: true, errors: (_c = {}, _c['$' + name2] = value2, _c), pendingValidations: [name2], isValidationPending: true }),
            } });
        var resultState = clear_async_error_1.clearAsyncErrorReducer(state, new actions_1.ClearAsyncErrorAction(test_util_1.FORM_CONTROL_INNER_ID, name2));
    ...
    it('should mark state as validation pending if child group is validation pending', function () {
        var name = 'required';
        var state = __assign({}, test_util_1.INITIAL_STATE_FULL, { pendingValidations: [name], isValidationPending: true, controls: __assign({}, test_util_1.INITIAL_STATE_FULL.controls, { inner3: __assign({}, test_util_1.INITIAL_STATE_FULL.controls.inner3, { pendingValidations: [name], isValidationPending: true }) }) });
        var resultState = clear_async_error_1.clearAsyncErrorReducer(state, new actions_1.ClearAsyncErrorAction(test_util_1.FORM_CONTROL_ID, name));
        expect(resultState.pendingValidations).toEqual([]);
        expect(resultState.isValidationPending).toEqual(true);
    });
    it('should mark state as validation pending if child array is validation pending', function () {
        var name = 'required';
        var state = __assign({}, test_util_1.INITIAL_STATE_FULL, { pendingValidations: [name], isValidationPending: true, controls: __assign({}, test_util_1.INITIAL_STATE_FULL.controls, { inner5: __assign({}, test_util_1.INITIAL_STATE_FULL.controls.inner5, { pendingValidations: [name], isValidationPending: true }) }) });
        var resultState = clear_async_error_1.clearAsyncErrorReducer(state, new actions_1.ClearAsyncErrorAction(test_util_1.FORM_CONTROL_ID, name));
        expect(resultState.pendingValidations).toEqual([]);
        expect(resultState.isValidationPending).toEqual(true);
    });
