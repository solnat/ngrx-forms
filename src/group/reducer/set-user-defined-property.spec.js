...
describe("form group " + set_user_defined_property_1.setUserDefinedPropertyReducer.name, function () {
    ...
    it('should update state user defined properties for children', function () {
        var prop = 'prop';
        var value = 12;
        var resultState = set_user_defined_property_1.setUserDefinedPropertyReducer(test_util_1.INITIAL_STATE, new actions_1.SetUserDefinedPropertyAction(test_util_1.FORM_CONTROL_INNER_ID, prop, value));
        expect(resultState.controls.inner.userDefinedProperties).toEqual((_a = {},
            _a[prop] = value,
            _a));
        var _a;
    });
