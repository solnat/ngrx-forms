...
describe("form array " + set_async_error_1.setAsyncErrorReducer.name, function () {
    ...
    it('should aggregate child errors', function () {
        ...
        var resultState = set_async_error_1.setAsyncErrorReducer(state, new actions_1.SetAsyncErrorAction(test_util_1.FORM_CONTROL_0_ID, name, value));
        expect(resultState.errors).toEqual({ _0: (_a = {}, _a['$' + name] = value, _a) });
    ...
    it('should aggregate child errors for group children', function () {
        var name = 'required';
        var value = true;
        var state = __assign({}, test_util_1.INITIAL_STATE_NESTED_GROUP, { isValidationPending: true, controls: [
    ...
    it('should aggregate child errors for array children', function () {
        var name = 'required';
        var value = true;
        var state = __assign({}, test_util_1.INITIAL_STATE_NESTED_ARRAY, { isValidationPending: true, controls: [
    ...
    it('should aggregate multiple child errors', function () {
        ...
        var value2 = 0;
        var state = __assign({}, test_util_1.INITIAL_STATE, { isValidationPending: true, controls: [
                __assign({}, test_util_1.INITIAL_STATE.controls[0], { pendingValidations: [name1], isValidationPending: true }),
                __assign({}, test_util_1.INITIAL_STATE.controls[1], { pendingValidations: [name2], isValidationPending: true }),
            ] });
        var resultState = set_async_error_1.setAsyncErrorReducer(state, new actions_1.SetAsyncErrorAction(test_util_1.FORM_CONTROL_0_ID, name1, value1));
        resultState = set_async_error_1.setAsyncErrorReducer(resultState, new actions_1.SetAsyncErrorAction(test_util_1.FORM_CONTROL_1_ID, name2, value2));
        expect(resultState.errors).toEqual({ _0: (_a = {}, _a['$' + name1] = value1, _a), _1: (_b = {}, _b['$' + name2] = value2, _b) });
        expect(resultState.isValid).toEqual(false);
        expect(resultState.isInvalid).toEqual(true);
        expect(resultState.isValidationPending).toEqual(false);
        var _a, _b;
    ...
    it('should track child errors and own errors when own errors are changed', function () {
        ...
        var state = __assign({}, test_util_1.INITIAL_STATE, { errors: {
                _0: (_a = {}, _a['$' + name2] = value2, _a),
            }, isValid: false, isInvalid: true, pendingValidations: [name1], isValidationPending: true, controls: [
                __assign({}, test_util_1.INITIAL_STATE.controls[0], { isValid: false, isInvalid: true, errors: (_b = {}, _b['$' + name2] = value2, _b) }),
            ] });
        ...
        expect(resultState.errors).toEqual((_c = {}, _c['$' + name1] = value1, _c._0 = (_d = {}, _d['$' + name2] = value2, _d), _c));
        var _a, _b, _c, _d;
    });
    it('should track own errors and child errors when child errors are changed', function () {
        ...
        var state = __assign({}, test_util_1.INITIAL_STATE, { isValid: false, isInvalid: true, errors: (_a = {}, _a['$' + name1] = value1, _a), isValidationPending: true, controls: [
                __assign({}, test_util_1.INITIAL_STATE.controls[0], { pendingValidations: [name2], isValidationPending: true }),
            ] });
        var resultState = set_async_error_1.setAsyncErrorReducer(state, new actions_1.SetAsyncErrorAction(test_util_1.FORM_CONTROL_0_ID, name2, value2));
        expect(resultState.errors).toEqual((_b = {}, _b['$' + name1] = value1, _b._0 = (_c = {}, _c['$' + name2] = value2, _c), _b));
        var _a, _b, _c;
    });
